    ...
    match runtime::get_tag(term) {
      ...
      runtime::SUP => {
        ...
        if let Some(val) = stack.last() {
          ...
          return Box::new(lang::Term::Sup { val0, val1 });
        }
      }
      runtime::DP0 => {
        let col = runtime::get_ext(term);
      ...
      runtime::U60 => {
        ...
        return Box::new(lang::Term::U6O { numb });
      }
      runtime::F60 => {
        let numb = runtime::get_num(term);
        return Box::new(lang::Term::F6O { numb });
      }
      runtime::CTR | runtime::FUN => {
      ...
      match item {
        ...
        StackItem::Term(term) => {
          match runtime::get_tag(term) {
            ...
            runtime::U60 => {
              let numb = runtime::get_num(term);
              output.push(lang::Term::U6O { numb });
            }
            runtime::F60 => {
              let numb = runtime::get_num(term);
              output.push(lang::Term::F6O { numb });
            }
            runtime::CTR => {
              let arit = runtime::arity_of(&prog.arit, term);
              stack.push(StackItem::Resolver(term));
