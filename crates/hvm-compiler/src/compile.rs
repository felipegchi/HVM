...
use hvm_runtime::language as language;
use hvm_runtime::runtime as runtime;

use hvm_syntax as syntax;
...
pub fn build_rulebook(book: &language::rulebook::RuleBook) -> (String, String) {
  ...
  // precomp.rs
  let precomp_rs : &str = todo!("./../runtime/base/precomp.rs");
  ...
  // reducer.rs
  let reducer_rs : &str = todo!("./../runtime/base/reducer.rs");
